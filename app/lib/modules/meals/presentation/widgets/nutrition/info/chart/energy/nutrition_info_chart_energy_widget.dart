...
class NutritionInfoChartEnergyWidget extends BaseStatelessWidget {
  const NutritionInfoChartEnergyWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return NutritionInfoCardWidget(
      nutrition: totalNutrition.energy,
  ...
  PieChartValue buildValue(Color color, IngredientModel ingredient, NutritionValueModel totalNutritionValue) {
    final nutritionValue = ingredient.nutrition.energy;
