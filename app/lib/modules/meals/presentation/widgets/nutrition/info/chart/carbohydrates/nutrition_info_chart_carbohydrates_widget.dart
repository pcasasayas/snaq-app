...
class NutritionInfoChartCarbohydratesWidget extends BaseStatelessWidget {
  const NutritionInfoChartCarbohydratesWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return NutritionInfoCardWidget(
      nutrition: totalNutrition.carbohydrates,
  ...
  PieChartValue buildValue(Color color, IngredientModel ingredient, NutritionValueModel totalNutritionValue) {
    final nutritionValue = ingredient.nutrition.carbohydrates;
